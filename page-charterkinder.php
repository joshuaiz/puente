<?php
/*
 Template Name: Charter Kinder Page
 *
 * 
*/
?>
...
<?php get_header(); ?>
	...
	<ul class="program-groups">
		...
		<?php // vars
		$anchor = get_field('program_group_anchor');
		$title = get_field('program_group_title');
		$stitle = get_field('program_spanish_title');
		$desc = get_field('program_general_description');
		$schedule = get_field('program_group_schedule');
		$spanish = get_field('program_group_spanish_schedule');
		$icon = get_field('program_group_icon');
